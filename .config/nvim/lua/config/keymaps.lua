...
keymap('n', '<leader>e', ':FlutterReload<CR>', { noremap = true, silent = true, desc = "Continue/Hot Reload" })
...
keymap('n', '<C-e>', ':NvimTreeToggle<CR>', { noremap = true, silent = true, desc = "Toggle File Explorer" })
keymap('n', '<C-q>', ':bd<CR>', { noremap = true, silent = true, desc = "Close Buffer" }) -- Changed from <C-w> to avoid conflict
